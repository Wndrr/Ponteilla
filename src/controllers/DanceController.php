...
==============================*/
	...
	/*----------  Section entry point  ----------*/
	$dance->get('/', function() use($app)
	{
		/*=======================================================
		=            Build list of path for carousel            =
		=======================================================*/
				
			$carouselPath = 'dance/carousel/';
	    ...
	    return $app['twig']->render('sections/dance/index.twig', array("carouselImagesPath" => $filesWebPath));
	})
	->bind('dance_index');
